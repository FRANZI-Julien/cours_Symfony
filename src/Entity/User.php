...
class User implements UserInterface, PasswordAuthenticatedUserInterface
{
    ...
    public function addUserGame(Game $userGame): self
    {
        if (!$this->user_game->contains($userGame)) {
            $this->user_game->add($userGame);
        }

        return $this;
    }

    public function removeUserGame(Game $userGame): self
    {
